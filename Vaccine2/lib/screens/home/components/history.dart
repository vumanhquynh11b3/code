...
class _ExampleAppState extends State<ExampleApp> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      SqlConn.readData(
          "select NgayTiem,LoaiVaccine,DiaDiem,SLNguoiDuKien from DotTiemChung Where NgayTiem >='" + today.toString() + "'").then((
          value) {
        setState(() {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  '${ListQr[index].dt.day}-${ListQr[index].dt
                                      .month}-${ListQr[index].dt.year}',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 15,
                                  ),
...
class History{
  ...
  History({required this.dt,required this.vctype,required this.diadiem,required this.sldukien});
